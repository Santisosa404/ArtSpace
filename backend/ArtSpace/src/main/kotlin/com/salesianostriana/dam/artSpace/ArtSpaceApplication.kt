...
//        var user5 = User("Pol_art",passwordEncoder.encode("miclave123"),"Pablo Alvarez","polart@correo.com","Calle San vicente de Paul nº56","Sevilla","Tatuador y amante del arte", mutableSetOf("USER"))
//
...
//
        //Guardado
//        uR.saveAll(mutableListOf(user1,user2,user3,user4,user5))
